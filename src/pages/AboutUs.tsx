    ...
    const teamMembers = [
        {
            ...
            image: require("./../images/vandana.jpg"),
            ...
            {teamMembers.map((member, index) => (
                <div className="profile-card" key={index}>
                    ...
                    <div className="profile-content">
                        <p className={expandedCards[index] ? "" : "truncate"}>{member.content}</p>
                        {!expandedCards[index] && member.content.length > 100 && (
                            <span className="more-link" onClick={() => toggleExpand(index)}> More...</span>
                        )}
                    </div>
                    </div>
                </div>
